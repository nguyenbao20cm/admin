                        ...
                        <div className="card-body" >
                            <div>
                                <div className="form-group">
                                    ...
                                    <div><input className="form-control w-100" type="text" onChange={(e) => this.ChangeNameinputProduct(e)} placeholder="Name" />
                                    </div>
                                </div>
                    ...
                    <div>
                        <table id="example" className='table table-striped'>
                            ...
                            <tbody>
                                ...
                                {a.filter((item) => {
                                    return this.state.NameinputProduct.toLowerCase() === ""
                                        ? item
                                        : item.name.toLowerCase().includes(this.state.NameinputProduct);
                                })
                                    .map(dep =>
                                        <tr >
                                            <td>
