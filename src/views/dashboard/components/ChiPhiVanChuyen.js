...
const YearlyBreakup = () => {
    ...
    useEffect(() => {
        ...
        fetch(variable.API_URL + "Inovices/GetAllInoviceTotal/" + year.getFullYear(), {
            method: "GET",
            headers: {
        ...
        fetch(variable.API_URL + "Inovices/GetAllInoviceTotal/" + year.getFullYear() - 1, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                Accept: 'application/json',
    ...
    var nam = "Doanh thu trong năm " + abc.getFullYear()
    return (
